            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link disabled" href="MascotasUsuario.php">Mascotas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="Usuario.php">Mi Perfil (<?php echo $usuario ?>)</a>
                        </li>
                ...
                <div class="row p-5">
                    ...
                    if ($band === 1) {
                        ...
                        <div class="text-center containter-fluid">
                            <input type="submit" class="btn btn-outline-dark text-center btn-lg" value="Confirmar Adopcion">
                        </div>
